(custom-set-variables
 ...
 '(auto-save-file-name-transforms
   '(("\\`/[^/]*:\\([^/]*/\\)*\\([^/]*\\)\\'" "/var/folders/Gf/GfQtOY0rGnK+iehSsqpuhU+++TI/-Tmp-/\\2" t)
     (".*" "~/.backups/" t)))
 ...
 '(mm-discouraged-alternatives '("text/html" "multipart/mixed"))
